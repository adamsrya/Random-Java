...
public class Tugas5_172479 {
    ...
    String[] nama = {}, nim = {}, umur = {};
      ...
      public static void dam(String[] data){
          String loop;
          Boolean stop = false; 
        ...
        while(!stop){
            ...
            nim = nim.push(nim, input.readLine());
            System.out.print("Nama  :");
            nama = nama.push(nama, input.readLine());
            System.out.print("Umur  :");
            umur = umur.push(umur, input.readLine());
